  ...
  return [
    ...
    },
    {
      ...
      children: [
        ...
        { text: "My Team", path: "/myteam", icon: <PeopleIcon />, show: (!isIndividual && !isCRM) || isAdmin },
        { text: "Evaluation", path: "/evaluation", icon: <AssignmentTurnedInIcon />, show: !isIndividual && !isCRM },
        { text: "Team Score", path: "/score", icon: <ScoreboardIcon />, show: !isIndividual && !isCRM },
        { text: "My Score", path: "/myscore", icon: <ScoreboardIcon />, show: true },
        { text: "Team Feedback", path: "/feedback", icon: <ThumbsUpDownIcon />, show: !isIndividual && !isCRM },
