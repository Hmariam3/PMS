...
import { fetchSystemData as fetchMetricData, ICON_MAP, TYPE_MAP, quarterProgress } from "../utils/metricEngine";
...
const MyDashboard = () => {
  ...
  // Delegates to the shared metric engine (single source of truth with DashboardTeam)
  const fetchSystemData = (type, requestData, targetsCache) =>
    fetchMetricData(axios, baseUrl, type, requestData, targetsCache);
